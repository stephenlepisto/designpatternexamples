...
namespace DesignPatternExamples_cpp
{
    ...
    public:
        ...
        std::string _StringListToCommaArray(const std::vector<std::string>& items)
        {
            std::ostringstream output;
        ...
        void Mediator_Exercise()
        {
            ...
            std::cout << std::format("    All groups: {0}", _StringListToCommaArray(mediator.GetAllGroups())) << std::endl;

            std::cout << "  Operation 2: Show all users" << std::endl;
            std::cout << std::format("    All users : {0}", _StringListToCommaArray(mediator.GetAllUsers())) << std::endl;
            ...
            std::cout << std::format("  {0}", mediator.IsUserInGroup(userName, groupName) ? "Yes" : "No") << std::endl;

            std::cout << "  Operation 4: Show all users in a specific group." << std::endl;
            groupName = "Users";
            StringList userNames = mediator.GetUsersInGroup(groupName);
            std::cout << std::format("    All users in '{0}' group: {1}", groupName, _StringListToCommaArray(userNames)) << std::endl;
            ...
            std::cout << std::format("    All groups with user '{0}': {1}", userName, _StringListToCommaArray(groupNames)) << std::endl;
            ...
            std::cout << std::format("      Start: all groups with user '{0}': {1}", userName, _StringListToCommaArray(groupNames)) << std::endl;
            std::cout << "      Removing..." << std::endl;
            mediator.RemoveUserFromAllGroups(userName);
            groupNames = mediator.GetGroupsWithUser(userName);
            std::cout << std::format("      End: all groups with user '{0}': {1}", userName, _StringListToCommaArray(groupNames)) << std::endl;
            ...
            for(std::string name : groupNames)
            {
                ...
                std::cout << std::format("      Users in group '{0}': {1}", name, _StringListToCommaArray(userNames)) << std::endl;
            }
