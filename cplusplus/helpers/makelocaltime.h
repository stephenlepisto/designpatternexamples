...
namespace Helpers
{
    ...
    /// returns nullptr, indicating an error (runtime constraint violation or a
    /// failure to convert the specified time to local calendar time).</returns>
    /// <remarks>
    /// This is an example of a function acting as an adapter.  The rest of the
    /// program just wants to convert a time stamp to local time and doesn't
    /// want to know about the differences between implementations of the C++
    /// library.
    /// </remarks>
