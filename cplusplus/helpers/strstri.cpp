...
// Module     : strstri
//
// Description: Function to search for one string in another in a case-
//              insensitive way (otherwise this is identical to the standard
//              C library function strstr()).
//
//              This function is not in the name space since I want to be
//              able to use it anywhere I would normally use strstr() (i.e.,
//              I want to treat strstri as a C Library function).
//
//////////////////////////////////////////////////////////////////////////////
