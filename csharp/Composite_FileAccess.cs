...
// of the file or directory.  GetEntry() returns an IFileDirEntry presenting
...
namespace DesignPatternExamples_csharp
{
    public static class Composite_FileAccess
    {
        ...
        /// <returns>Returns an IFileDirEntry object for the requested object;
        /// otherwise, returns null, indicating the entry was not found.</returns>
        private static IFileDirEntry _FindEntry(string filepath)
        {
            IFileDirEntry root = rootEntry;
            ...
            for (int index = 0; index < numComponents; ++index)
            {
                ...
                IFileDirEntry[] children = root.Children;
                if (children == null)
                {
                ...
                foreach (IFileDirEntry child in children)
                {
        ...
        public static IFileDirEntry GetEntry(string filepath)
        {
